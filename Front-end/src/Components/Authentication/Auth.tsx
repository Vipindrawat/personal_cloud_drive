            ...
            <div className="2xl:w-[62.5%] xl:w-9/12 lg:w-10/12 w-[94%] 2xl:min-h-[38rem] lg:min-h-[35rem] md:min-h-[30rem] sm:min-h-[27rem] min-h-[32rem] flex flex-row bg-white rounded-2xl  ">
                ...
                <div className="sm:w-1/2 w-full flex flex-col items-center justify-start">
                    ...
                    <div className="flex flex-row font-Josefin lg:text-xl text-lg md:py-7 py-5">
                        <span className={`md:px-11 px-8 py-2 z-20 font-bold rounded-md ${location.pathname == "/signup" ? "bg-gradient-to-r from-green-400 to-blue-500 text-white  hover:from-pink-500 hover:to-yellow-500" : "bg-white text-black hover:cursor-default"}`}>
                            <Link to="/signin">Sign in</Link>
                        </span>
                        <span className={`md:px-11 px-8 py-2 z-20 font-bold rounded-md ${location.pathname == "/signin" ? "bg-gradient-to-r from-green-400 to-blue-500 text-white  hover:from-pink-500 hover:to-yellow-500" : "bg-white text-black cursor-default"}`}>
